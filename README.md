...
NOTE: Due to problems with trying to maintain the usage of ARP for name resolution, this project is closed, but a working implementation of INT in an IPv6 environment can be seen at https://github.com/davidcc73/p4-srv6-INT 
